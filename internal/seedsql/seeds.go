...
INSERT INTO sell_categories (id, name, icon, color, status, created_at) VALUES
  ...
  ('a1000001-0000-4000-8000-000000000005', 'Bags & Luggage', '{"name":"mdiBagPersonal","library":"mdi"}'::jsonb, '9C27B0', 'ACTIVE', NOW()),
  ('a1000001-0000-4000-8000-000000000006', 'Bicycles', '{"name":"bicycle","library":"mdi"}'::jsonb, '43B4AD', 'ACTIVE', NOW()),
  ('a1000001-0000-4000-8000-000000000007', 'Books & Media', '{"name":"mdiBookOpenPageVariant","library":"mdi"}'::jsonb, '6D4C41', 'ACTIVE', NOW()),
  ...
  ('a1000001-0000-4000-8000-00000000000c', 'Health & Beauty', '{"name":"mdiSpray","library":"mdi"}'::jsonb, 'E91E63', 'ACTIVE', NOW()),
  ...
  ('a1000001-0000-4000-8000-00000000000f', 'Jewelry & Watches', '{"name":"mdiWatch","library":"mdi"}'::jsonb, 'FFD700', 'ACTIVE', NOW()),
  ('a1000001-0000-4000-8000-000000000010', 'Kitchen & Dining', '{"name":"mdiSilverware","library":"mdi"}'::jsonb, 'FF7043', 'ACTIVE', NOW()),
  ('a1000001-0000-4000-8000-000000000011', 'Motorcycles', '{"name":"mdiMotorbike","library":"mdi"}'::jsonb, '455A64', 'ACTIVE', NOW()),
